...
Please look at [ChangeLog.md](ChangeLog.md) for details on what has changed in this version.


```
➤ unzip -l markdown-serve-v1.0.2-windows-amd64.d.zip
...
Please look at [Installation](README.md#installation) section in [README.md](README.md) for info on installing via Homebrew or compiling from source etc.
